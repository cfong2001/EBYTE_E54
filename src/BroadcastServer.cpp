...
<body>
<div class="hud-title" style="display:flex; justify-content:space-between; align-items:center; width:320px;"><span>E54 RADAR TRACKER HUD</span><span id="conn-status" style="color:#ff4444; font-size:12px;">● OFFLINE</span></div>
<div class="radar-box">
