...
<body>
<div class="hud-title">E54 RADAR TRACKER HUD<span id="conn-status" style="color: #1e3a45; font-size: 12px; margin-left: 10px;">● OFFLINE</span></div>
<div class="radar-box">
