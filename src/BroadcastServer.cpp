...
<body>
<div class="hud-title">E54 RADAR TRACKER HUD <span id="conn-status" style="color: #00ff88; margin-left: 10px; font-size: 12px; transition: color 0.3s;">● LIVE</span></div>
<div class="radar-box">
