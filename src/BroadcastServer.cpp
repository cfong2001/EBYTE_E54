...
<body>
<div class="hud-title">E54 RADAR TRACKER HUD <span id="conn-status" style="font-size:12px; color:#ffb000;">● CONN</span></div>
<div class="radar-box">
<svg viewBox="0 0 100 100" role="img" aria-label="Radar sweep map showing target positions">
<!-- Polar Distance Arcs -->
