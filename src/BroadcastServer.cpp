...
<body>
<div class="hud-title">E54 RADAR TRACKER HUD<span id="conn-status" style="margin-left: 10px; color: #00ff88; font-size: 12px;">● LIVE</span></div>
<div class="radar-box">
<svg viewBox="0 0 100 100" role="img" aria-label="Radar visualization">
<!-- Polar Distance Arcs -->
