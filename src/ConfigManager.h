...
private:
    ...
    void copyUINamespace(const char* srcNamespace, const char* destNamespace) {
        prefs.begin(srcNamespace, true);
        ...
        prefs.begin(destNamespace, false);
    ...
    void copyZoneNamespace(const char* srcNamespace, const char* destNamespace) {
        prefs.begin(srcNamespace, true);
...
public:
    ...
    void backupToFallback() {
        copyUINamespace("radar_ui", "fb_ui");
        copyZoneNamespace("radar_zones", "fb_zones");
    }

    void restoreFromFallback() {
        copyUINamespace("fb_ui", "radar_ui");
        copyZoneNamespace("fb_zones", "radar_zones");
    }
