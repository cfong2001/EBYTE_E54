...
public:
    ...
    void drawSelfTestScreen() {
        ...
        sprite.setCursor((tft.width() - titleTw) / 2, y);
        ...
        if (!selfTestDone) {
            ...
            int boxHeight = lh * 2 + 10;
            sprite.fillRect(10, y, 220, boxHeight, pulseColor);
            ...
            int tw_dots = sprite.textWidth("RUNNING TESTS...");
            sprite.setCursor((tft.width() - tw_dots) / 2, y + (boxHeight - lh) / 2);
            sprite.print(buf);
        ...
        sprite.setCursor((tft.width() - exitTw) / 2, 120 + lh * 2);
