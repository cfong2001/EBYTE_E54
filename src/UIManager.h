...
// PERFORMANCE OPTIMIZATION: Replaced Arduino String instantiations and .startsWith()
// with const char* and strncmp() in high-frequency UI/menu loops to eliminate heap
