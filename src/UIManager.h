...
public:
    ...
    void drawMenuTooltip(const char* selectedItemText) {
        ...
        // Optimization: C-string comparison avoids continuous String instantiation and heap fragmentation in 30Hz render loop.
...
inline void MainMenuView::handleMenuClick(UIManager* ui) {
    // Optimization: Using const char* and strncmp prevents Arduino String heap allocation overhead in hot UI loops.
