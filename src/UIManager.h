...
public:
    ...
    void drawBootScreen() {
        ...
        // Replace per-iteration sinf()/cosf() with fixed vector rotation
        // for 5 degree step (cos: 0.996194698091f, sin: 0.087155742747f)
        constexpr float rotCos = 0.996194698091f;
        constexpr float rotSin = 0.087155742747f;

        float startRad = -180.0f * 0.0174533f;
        float dirX = cosf(startRad);
        float dirY = sinf(startRad);
