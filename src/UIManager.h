...
public:
    ...
    void drawBootScreen() {
        ...
        // 73 precalculated cos/sin pairs for a = -180 to 180 step 5
        static constexpr struct { float cosA, sinA; } bootSpokes[73] = {
            {-1.00000000f, 0.00000128f}, // -180 deg
            {-0.99619484f, -0.08715445f}, // -175 deg
            {-0.98480797f, -0.17364688f}, // -170 deg
            {-0.96592611f, -0.25881800f}, // -165 deg
            {-0.93969297f, -0.34201911f}, // -160 deg
            {-0.90630829f, -0.42261723f}, // -155 deg
            {-0.86602598f, -0.49999902f}, // -150 deg
            {-0.81915271f, -0.57357550f}, // -145 deg
            {-0.76604503f, -0.64278686f}, // -140 deg
            {-0.70710748f, -0.70710611f}, // -135 deg
            {-0.64278835f, -0.76604384f}, // -130 deg
            {-0.57357723f, -0.81915146f}, // -125 deg
            {-0.50000066f, -0.86602503f}, // -120 deg
            {-0.42261899f, -0.90630746f}, // -115 deg
            {-0.34202090f, -0.93969232f}, // -110 deg
            {-0.25881985f, -0.96592563f}, // -105 deg
            {-0.17364889f, -0.98480761f}, // -100 deg
            {-0.08715648f, -0.99619466f}, // -95 deg
            {-0.00000064f, -1.00000000f}, // -90 deg
            {0.08715509f, -0.99619478f}, // -85 deg
            {0.17364763f, -0.98480785f}, // -80 deg
            {0.25881851f, -0.96592599f}, // -75 deg
            {0.34201971f, -0.93969280f}, // -70 deg
            {0.42261782f, -0.90630800f}, // -65 deg
            {0.49999967f, -0.86602563f}, // -60 deg
            {0.57357609f, -0.81915230f}, // -55 deg
            {0.64278734f, -0.76604468f}, // -50 deg
            {0.70710653f, -0.70710701f}, // -45 deg
            {0.76604426f, -0.64278781f}, // -40 deg
            {0.81915194f, -0.57357663f}, // -35 deg
            {0.86602533f, -0.50000018f}, // -30 deg
            {0.90630770f, -0.42261842f}, // -25 deg
            {0.93969256f, -0.34202027f}, // -20 deg
            {0.96592581f, -0.25881913f}, // -15 deg
            {0.98480773f, -0.17364825f}, // -10 deg
            {0.99619472f, -0.08715577f}, // -5 deg
            {1.00000000f, 0.00000000f}, // 0 deg
            {0.99619472f, 0.08715577f}, // 5 deg
            {0.98480773f, 0.17364825f}, // 10 deg
            {0.96592581f, 0.25881913f}, // 15 deg
            {0.93969256f, 0.34202027f}, // 20 deg
        ...
        for (int i = 0; i < 73; ++i) {
            int a = -180 + i * 5;
            float cosA = bootSpokes[i].cosA;
            float sinA = bootSpokes[i].sinA;
