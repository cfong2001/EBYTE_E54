...
## 2026-06-18 - Responsive Multi-line UI
**Learning:** Hardcoding Y-coordinates for text breaks visual alignment when accessibility settings like text scale are modified.
**Action:** Use a dynamic line height multiplier to ensure multi-line UI scales proportionally without overlap when text size is increased.
